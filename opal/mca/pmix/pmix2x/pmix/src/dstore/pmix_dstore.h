...
int pmix_dstore_store(pmix_peer_t *peer, const char *nspace, pmix_rank_t rank, pmix_kval_t *kv);
...
*/
typedef int (*pmix_dstore_base_module_store_fn_t)(pmix_peer_t *peer,
                                                  const char *nspace,
                                                  pmix_rank_t rank,
                                                  pmix_kval_t *kv);
...
*/
typedef int (*pmix_dstore_base_module_fetch_fn_t)(pmix_peer_t *peer,
                                                  const char *nspace,
                                                  pmix_rank_t rank,
                                                  const char *key,
                                                  pmix_value_t **kvs);
