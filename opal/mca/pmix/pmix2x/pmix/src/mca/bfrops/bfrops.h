 ...
 * when done */
typedef char* (*pmix_bfrops_API_get_available_modules_fn_t)(void);

/* Select a bfrops module for a given version */
typedef pmix_status_t (*pmix_bfrops_API_assign_module_fn_t)(struct pmix_peer_t *peer,
                                                            const char *version);
/* Construct a buffer for a given peer */
typedef pmix_buffer_t* (*pmix_bfrops_API_create_buffer_fn_t)(struct pmix_peer_t *pr);
typedef void (*pmix_bfrops_API_construct_buffer_fn_t)(struct pmix_peer_t *pr,
                                                      pmix_buffer_t *buf);
typedef pmix_status_t (*pmix_bfrop_API_pack_fn_t)(struct pmix_peer_t *peer,
                                                  pmix_buffer_t *buffer,
                                                  const void *src,
                                                  int32_t num_values,
                                                  pmix_data_type_t type);
typedef pmix_status_t (*pmix_bfrop_API_unpack_fn_t)(struct pmix_peer_t *peer,
                                                    pmix_buffer_t *buffer, void *dest,
                                                    int32_t *max_num_values,
                                                    pmix_data_type_t type);
typedef pmix_status_t (*pmix_bfrop_API_copy_fn_t)(struct pmix_peer_t *peer,
                                                  void **dest, void *src,
                                                  pmix_data_type_t type);
typedef pmix_status_t (*pmix_bfrop_API_print_fn_t)(struct pmix_peer_t *peer,
                                                   char **output, char *prefix,
                                                   void *src, pmix_data_type_t type);
typedef pmix_status_t (*pmix_bfrop_API_copy_payload_fn_t)(struct pmix_peer_t *peer,
                                                          pmix_buffer_t *dest,
                                                          pmix_buffer_t *src);
typedef pmix_status_t (*pmix_bfrop_API_value_xfer_fn_t)(struct pmix_peer_t *peer,
                                                        pmix_value_t *dest,
                                                        pmix_value_t *src);
typedef void (*pmix_bfrop_API_value_load_fn_t)(struct pmix_peer_t *peer,
                                               pmix_value_t *v, void *data,
                                               pmix_data_type_t type);
typedef pmix_status_t (*pmix_bfrop_API_value_unload_fn_t)(struct pmix_peer_t *peer,
                                                          pmix_value_t *kv, void **data,
                                                          size_t *sz, pmix_data_type_t type);
typedef pmix_value_cmp_t (*pmix_bfrop_API_value_cmp_fn_t)(struct pmix_peer_t *peer,
                                                          pmix_value_t *p1, pmix_value_t *p2);
typedef pmix_status_t (*pmix_bfrop_API_register_fn_t)(struct pmix_peer_t *peer,
                                                      ...
                                                      pmix_bfrop_print_fn_t print);
/* return the string name of a provided data type */
typedef const char* (*pmix_bfrop_API_data_type_string_fn_t)(struct pmix_peer_t *peer,
                                                            pmix_data_type_t type);


typedef struct {
    pmix_bfrops_API_get_available_modules_fn_t      get_available_modules;
    pmix_bfrops_API_assign_module_fn_t              assign_module;
    pmix_bfrops_API_create_buffer_fn_t              create_buffer;
    pmix_bfrops_API_construct_buffer_fn_t           construct_buffer;
    pmix_bfrop_API_pack_fn_t                        pack;
    pmix_bfrop_API_unpack_fn_t                      unpack;
    pmix_bfrop_API_copy_fn_t                        copy;
    pmix_bfrop_API_print_fn_t                       print;
    pmix_bfrop_API_copy_payload_fn_t                copy_payload;
    pmix_bfrop_API_value_xfer_fn_t                  value_xfer;
    pmix_bfrop_API_value_load_fn_t                  value_load;
    pmix_bfrop_API_value_unload_fn_t                value_unload;
    pmix_bfrop_API_value_cmp_fn_t                   value_cmp;
    pmix_bfrop_API_register_fn_t                    register_type;
    pmix_bfrop_API_data_type_string_fn_t            data_type_string;
} pmix_bfrops_API_module_t;

PMIX_EXPORT extern pmix_bfrops_API_module_t pmix_bfrops;
