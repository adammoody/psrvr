...
pmix_bfrops_API_module_t pmix_bfrops = {
  .get_available_modules = pmix_bfrops_stub_get_available_modules,
  .assign_module = pmix_bfrops_stub_assign_module,
  .create_buffer = pmix_bfrops_stub_create_buffer,
  .construct_buffer = pmix_bfrops_construct_buffer,
  .pack = pmix_bfrops_stub_pack,
  .unpack = pmix_bfrops_stub_unpack,
  .copy = pmix_bfrops_stub_copy,
  .print = pmix_bfrops_stub_print,
  .copy_payload = pmix_bfrops_stub_copy_payload,
  .value_xfer = pmix_bfrops_stub_value_xfer,
  .value_load = pmix_bfrops_stub_value_load,
  .value_unload = pmix_bfrops_stub_value_unload,
  .value_cmp = pmix_bfrops_stub_value_cmp,
  .register_type = pmix_bfrops_stub_register_type,
  .data_type_string = pmix_bfrops_stub_data_type_string
};
